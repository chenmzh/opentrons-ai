"""OT-2 motor music: verify a bass-register six-note Song of Storms motif.
...
metadata = {
    "protocolName": "OT-2 Song of Storms bass motif and pitch verification",
    "description": "Verify D2/F2/D3, then play the motif two octaves lower using X at fixed Z.",
}
requirements = {"robotType": "OT-2", "apiLevel": "2.22"}

CENTER_X_MM = 196.5
CENTER_Y_MM = 178.75
# The sweep spectra show a harmonic spacing of about 4.98375 Hz per mm/s.
# Lowering the motif by two octaves keeps all note speeds below 30 mm/s.
HZ_PER_MM_S = 4.98375
NOTES = (("D2", 38), ("F2", 41), ("D3", 50))
